...
This machine handles button-based pagination, for instance paginating a tabular dataset. If you're looking for infinite scroll, we'll cover that somewhere else.
